...
always @(posedge clk or posedge reset) begin
    if (reset) begin
        ...
        end else if (round_cnt == 11) begin
            desired_round <= 1'b0;
        end
        ...
        case (state)
            ...
            WAIT_KEY_EXPANSION: begin
                ...
                //Eger bir önceki tur sifreleme yapıldıysa bu kod ile outputa basılıyor
                //bir cycle kazanmak için done_state yapmak yerine burada tanımladık
