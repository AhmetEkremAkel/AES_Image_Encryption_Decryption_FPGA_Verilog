...
HD_PWD='D:/Vivado documents/AES_CTR_Encryption_Decryption/aes_ctr_core_pipelined/AES_ctr_core_pipelined.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_encryption.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_encryption.tcl
