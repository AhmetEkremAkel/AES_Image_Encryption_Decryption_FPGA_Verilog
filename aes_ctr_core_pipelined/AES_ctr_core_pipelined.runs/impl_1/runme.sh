...
HD_PWD='D:/Vivado documents/AES_CTR_Encryption_Decryption/aes_ctr_core_pipelined/AES_ctr_core_pipelined.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_encryption.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_encryption.tcl -notrace
